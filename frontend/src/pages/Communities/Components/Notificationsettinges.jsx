    ...
    /* Header */}
        <div className="p-4 border-b flex items-center justify-center">
          <div className="flex items-center justify-between w-full max-w-sm">
            <h2 className="text-xl font-medium text-blue-500">Notification Settings</h2>
            <button 
            onClick={onClose}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-base font-medium text-gray-700">Notification Categories</h3>
          <input 
            type="text"
        ...
        {/* Email Section */}
        <div className="space-y-2">
          <h3 className="text-base font-medium text-gray-700">Notification Email</h3>
          <input 
            type="email"
